"""
In-situ stochastic computing (Corresponding to Noisy DropConnect method)
...
class LeNet_This_work(Model):
    def __init__(self):
        super(LeNet_This_work, self).__init__()
        ...
        self.fc1 = DropConnect_noise(units=120, rate=1, activation='relu')
        self.fc2 = DropConnect_noise(units=84, rate=0.7, activation='relu')  # keep rate
