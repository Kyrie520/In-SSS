...
class CustomSGD(tf.keras.optimizers.Optimizer):
    ...
    def _resource_apply_dense(self, grad, var, apply_state=None):
        ...
        if 'fc2' in var.name:
            tf.compat.v1.assign(var, var - lr_t * 0.7 * grad)
        else:
            tf.compat.v1.assign(var, var - lr_t * grad)
...
with open('accuracy of LeNet_Traditional stochastic strategy.csv', mode='w', newline='') as file:
