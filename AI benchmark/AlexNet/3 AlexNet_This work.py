...
class AlexNet_Stochastic_strategy1(Model):
    def __init__(self):
        super(AlexNet_Stochastic_strategy1, self).__init__()
        ...
        self.fc1 = DropConnect_noise1(units=512, rate=1)
        self.fc2 = DropConnect_noise1(units=128, rate=0.3)  # keep rate
...
if __name__ == '__main__':
    ...
    model = AlexNet_Stochastic_strategy1()
