...
class SNN_This_work(Model):
    def __init__(self):
        super(SNN_This_work, self).__init__()
        self.flatten = layers.Flatten()
        self.fc1 = DropConnect_noise(units=2000, rate=0.5, activation='relu')
        self.lif1 = LeakySurrogate(beta=0.9, p_neuron=1)
        self.fc2 = DropConnect_noise(units=10, rate=1, activation='softmax')
