...
class SNN_Dropout(Model):
    def __init__(self):
        super(SNN_Dropout, self).__init__()
        self.flatten = layers.Flatten()
        self.fc1 = layers.Dense(2000, activation=None)
        self.dropout1 = layers.Dropout(1 - 0.1)  # 1-keep rate
        self.lif1 = LeakySurrogate(beta=0.9, p_neuron=1)
        self.fc2 = layers.Dense(10, activation='softmax')
        self.dropout2 = layers.Dropout(1-1)
...
save_path = 'accuracy of SNN_Dropout.csv'
